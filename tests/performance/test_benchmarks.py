...
class TestPerformanceBenchmarks:
    ...
    def test_matrix_operations_benchmark(self, benchmark, matrix_size):
        ...
        def matrix_multiplication():
            ...
            matrix_a = np.random.complex128((matrix_size, matrix_size))
            matrix_b = np.random.complex128((matrix_size, matrix_size))
    ...
    def test_quantum_memory_retrieval_benchmark(self, benchmark):
        ...
        def quantum_memory_retrieval():
            ...
            memory_size = 1000
            query_vector = np.random.complex128(memory_size)
            memory_matrix = np.random.complex128((memory_size, memory_size))
