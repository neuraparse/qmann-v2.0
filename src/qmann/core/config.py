...
class QMANNConfig:
    ...
    def _validate_config(self):
        ...
        # Quantum validation
        if self.quantum.memory_qubits + self.quantum.ancilla_qubits > self.quantum.max_qubits:
    ...
    def _create_directories(self):
        ...
        for dir_path in [self.data_dir, self.output_dir, self.checkpoint_dir, self.log_dir]:
    ...
    def get_hardware_requirements(self) -> Dict[str, Any]:
        ...
        return {
            'quantum_qubits_required': self.quantum.memory_qubits + self.quantum.ancilla_qubits,
    ...
    def _estimate_memory_requirements(self) -> float:
        ...
        quantum_memory = 2 ** self.quantum.memory_qubits * 16 / (1024**3)  # Complex128 in GB
        
        # Classical model memory
        classical_memory = self.classical.hidden_size * self.classical.num_layers * 4 / (1024**3)
